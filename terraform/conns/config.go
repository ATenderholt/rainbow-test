...
func (c *Config) Client(ctx context.Context) (interface{}, diag.Diagnostics) {
	...
	client.FMSConn.Handlers.Retry.PushBack(func(r *request.Request) {
		...
		// Reference: https://github.com/ATenderholt/rainbow-test/issues/23946
		case "PutPolicy":
	...
	// Reference: https://github.com/ATenderholt/rainbow-test/issues/17996
	...
	// Reference: https://github.com/ATenderholt/rainbow-test/issues/19215
